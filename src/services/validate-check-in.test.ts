...
describe('Validate Check-in Use Case', () => {
    ...
    test('user be able to validate the check-in', async () => {
    ...
    test('user not be able to validate an inexistent check-in', async () => {
        await expect(() => 
            sut.execute({
    ...
    test('should not be able to validate the check-in after 20 minutes of its creation', async () => {
        vi.setSystemTime(new Date(2023, 0, 10, 15, 30))
